...
Ce document a été conçu afin de vous servir de support additionnel en plus de slides du cours et des exercices. Les questions n'ont pas fait l'objet du contrôle strict que nous appliquons pour la préparation des ressources documentaires. de questions est destinée à vous servir de ressource si vous souhaitez vous entraîner davantage. \newline 
