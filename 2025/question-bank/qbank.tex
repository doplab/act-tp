...
\newcommand{\releaseDate}{18.12.2025}
...
\input{./sections/01_architecture_numeration.tex}
\pagebreak
\section{Systèmes d'exploitation et langages de programmation}
\input{./sections/02_systeme_exploitation.tex}
\pagebreak
\section{Bases de la programmation}
\input{sections/03_programmation_bases.tex}
\pagebreak
\section{Programmation orientée objet}
\input{sections/04_orientee_objet.tex}
\pagebreak
\section{Logique et théorie des ensembles}
\input{sections/05_logique_ensemble.tex}
\pagebreak
\section{Algorithmes et complexité}
\input{sections/06_algo_complexite.tex}
