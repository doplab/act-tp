...
\begin{Exercice}[5 minutes] \textbf{Entiers signés négatifs}\\
    En utilisant le résultat de la question précédente, convertir sur 8 bits -113$_{(10)}$ en base binaire. Utiliser la représentation \textbf{signée} à la diapositive 13 du cours. \\
...
\begin{Exercice}[5 minutes] \textbf{Complément à 1}\\
    ...
    \begin{conseil}
        \begin{itemize}
        	...
        	\item Pour étudier la différence, il faut regarder les différentes manières d'exprimer -0 en binaire (se référer à la diapositive 14 du cours).
        \end{itemize} 
    \end{conseil}
...
\begin{Exercice}[10 minutes] \textbf{Floating point}\\
    ...
    \begin{itemize}
    	\item Se référer à la diapositive 21 du cours pour plus de détails.
...
\hline
$p$ & $q$ & $\neg p$ & $\neg q$ & $\neg p \vee q$ & $p \vee \neg q$ & LHS & RHS & LHS $\Leftrightarrow$ RHS \\
\hline
T & T & F & F & T & T & T & T & T \\
T & F & F & T & F & T & F & F & T \\
F & T & T & F & T & F & F & F & T \\
...
\end{tabular}
\end{center}
Cette opération booléenne est appelé \href{https://en.wikipedia.org/wiki/XNOR_gate}{\textbf{XNOR}}.
    \end{solution}
...
Consultez \href{https://moodle.unil.ch/pluginfile.php/3705947/mod_resource/content/8/jswitch.pdf}{cette mémoire disponible sur Moodle}
pour comprendre le fonctionnement d'un \texttt{switch} en Java.  \newline 

\begin{Exercice}[5 minutes] 
    Écrire le code Java qui demande à l'utilisateur d'entrer l'étape d'éxecution d'une instruction et affiche les étapes qui reste à exécuter (y compris l'étape courante). 
    ...
    la saisie texte de l'utilisateur, utilisez \texttt{nextLine()} telle qu'elle est définie dans \href{https://docs.oracle.com/en/java/javase/24/docs/api/java.base/java/util/Scanner.html\#nextLine()}{la documentation Java en ligne}.
    \end{conseil}
...
\end{lstlisting}
   \end{Example}
    ...
    \begin{solution}
         \lstinputlisting{updated/Questions/Question12.java}
    \end{solution}
...
\begin{solution}
 \lstinputlisting{updated/Questions/Question13.py}
\end{solution}

\begin{solution}
 \lstinputlisting{updated/Questions/Question13_2.py}
\end{solution}
\end{Exercice}
...
\begin{Exercice}
Soit la chaîne de caractères: \texttt{School of Criminal Sciences\textbackslash nUNIL}. 
\begin{enumerate}
\item Affichez cette chaîne en Python et en Java. Pourquoi est-elle séparée par une nouvelle ligne ?
\item Essayez d'afficher uniquement la chaîne \texttt{School of Criminal Sciences} en sélectionnant une sous-chaîne de la chaîne initiale. Pour Python, consultez \href{https://docs.python.org/fr/3.13/library/functions.html\#slice}{la documentation en ligne} et pour Java, consultez \href{https://docs.oracle.com/en/java/javase/25/docs/api/java.base/java/lang/String.html\#substring(int,int)}{la documentation Java en ligne}.
\item Accédez au troisième caractère de la chaîne en Python et en Java. Pour Java, consultez \href{https://docs.oracle.com/en/java/javase/25/docs/api/java.base/java/lang/String.html\#charAt(int)}{la documentation en ligne}.
\end{enumerate}
\begin{solution}
   \lstinputlisting{updated/Questions/Question15.py}
\end{solution}
\begin{solution}
   \lstinputlisting{updated/Questions/Question15.java}
\end{solution}
\end{Exercice}
