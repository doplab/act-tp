...
\begin{Exercice}[5 minutes] \textbf{Entiers signés négatifs}\\
    En utilisant le résultat de la question précédente, convertir sur 8 bits -113$_{(10)}$ en base binaire. Utiliser la représentation de \textbf{signed magnitude} à la diapositive 10 du cours. \\
...
\begin{Exercice}[5 minutes] \textbf{Complément à 2}\\
    Quel est la représentation du complément à 2 (two complement) de -113$_{(10)}$ et quelle est l'utilité de cette représentation ? \\
...
\begin{Exercice}[5 minutes]
    ...
    \begin{enumerate}
        ...
        \item Re-écrire cette condition à l'aide de la loi DeMorgan (diapositive 23 du cours). 
    \end{enumerate}
\begin{center}
...
\begin{tikzpicture}[scale=1.3]
    ...
    \node[gray, above] at (3.25,1.5) {écart};
    
    \draw[<->, dashed, gray] (3,-0.5) -- (5,-0.5);
    \node[gray, above] at (4,-0.5) {écart};
