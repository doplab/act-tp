...
\begin{Exercice}[20 minutes] \textbf{Le juste prix }\\
  ...
  \lstinputlisting{code/advanced/question2-enonce.py}
  
  \begin{solution}
   \lstinputlisting{code/advanced/question2-1.py}
   ...
   \lstinputlisting{code/advanced/question2-2.py}
...
\begin{Exercice}[20 minutes] \textbf{Pierre, Feuille, Ciseaux }\\
  ...
  \lstinputlisting{code/advanced/question3-enonce.py}
