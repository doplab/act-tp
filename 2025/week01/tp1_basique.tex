...
\begin{tikzpicture}[scale=1.3]
    ...
    \draw[red, thick, bend right=40] (node1) to (node2);
    \draw[red, thick, bend right=40] (node2) to (node3);
    \draw[red, thick, bend right=40] (node3) to (node4);
    \draw[red, thick, bend right=40] (node4) to (node5);
    \draw[red, thick, bend right=40] (node5) to (node6);
...
\begin{Exercice}[10 minutes] \textbf{Decode}
    ...
    \begin{conseil}
        ...
        Utilisez la même convention que celle présentée dans les diapositives du cours (Computer Architecture - Page 16) \\
