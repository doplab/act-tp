...
\begin{Exercice}[5 minutes]  \textbf{Conversion $Base_{10}$ - $Base_2$}\\
    ...
    \begin{conseil}
        ...
        \begin{tabular}{| C{0.15\textwidth} | C{0.1\textwidth} | C{0.1\textwidth} | C{0.1\textwidth} | C{0.1\textwidth} | C{0.1\textwidth} | C{0.1\textwidth} |} 
            \hline
    ...
    \begin{solution}
<<<<<<< HEAD
        Il existe 2 méthodes pour simplifier la conversion d'un nombre de la base 10 à la base 2. \\
=======
        Il existe deux méthodes pour simplifier la conversion d'un nombre de la base 10 à la base 2. Ici le nombre 45 sera entièrement développé. \\
>>>>>>> fa4e287 (remove metals folder and add changes to TP1)
