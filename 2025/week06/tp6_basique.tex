...
\begin{solution}[Java]
\lstinputlisting[language=Java]{ressources/Palindrome.java}
\end{solution}
\begin{solution}[Python]
    \lstinputlisting[language=Python]{ressources/palindrome.py}
\end{solution}
...
\begin{conseil}
    ...
    \end{itemize}
\end{conseil}
% \vspace*{-2cm} was a necessary thing to avoid having the code collide with the page number
\begin{solution}
...
\end{solution}
\begin{solution}
    \lstinputlisting{solutions/Main.java}
\end{solution}
\end{Exercice}
\newpage
