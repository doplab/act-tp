...
\lstinputlisting{code/advanced/Fighter.java}
...
\begin{solution}
	\lstinputlisting{solutions/advanced/isAlive.java}
\end{solution}
\end{Exercice}
...
\end{conseil}
\begin{solution}
	\lstinputlisting{solutions/advanced/checkDead.java}
\end{solution}
\end{Exercice}
...
\begin{solution}
	\lstinputlisting{solutions/advanced/checkHealth.java}
\end{solution}
\end{Exercice}
...
\begin{solution}
	\lstinputlisting{solutions/advanced/attack.java}
\end{solution}
\end{Exercice}
...
\lstinputlisting[language=TeX]{text/question4_advanced_output.txt}
...
\begin{Exercice}[30 minutes]\textbf{Un exemple appliqué}
    ...
    \lstinputlisting{code/advanced/Enseignant.py} 
    ...
    \begin{solution}
    \lstinputlisting{solutions/advanced/Enseignant.py} 
    \end{solution}
    \end{Exercice}
\end{document}
