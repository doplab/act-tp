...
\begin{Exercice} [30 minutes] \textbf{Tri fusion (Merge Sort) - Python} \\
    ...
    \begin{solution}
        \textbf{Python :}
        \lstinputlisting[language=python, lastline=51]{solutions/merge_sort.py}
    \end{solution}

    \begin{solution}
\lstinputlisting[language=python, firstline=52, firstnumber=52]{solutions/merge_sort.py}
    \end{solution}
...
\begin{Exercice} [20 minutes] \textbf{Tri à bulles (Bubble Sort) - Python \optionnel} \\
    ...
    \begin{itemize}
            \item \textbf{Python :}
                \lstinputlisting{ressources/tri_fusion_basique.py} 
        \end{itemize}
        ...
        \begin{solution}
        \textbf{Python :}
        \lstinputlisting{solutions/tri_fusion_basique.py}
