...
\begin{Exercice}[10 minutes] \textbf{Somme des chiffres} \\
    ...
    \begin{solution}
    \textbf{Python :}
        \lstinputlisting{solutions/somme_chiffres.py}
...
\begin{Exercice}[15 minutes] \textbf{Insertion dans une liste triée - Python}\\
    ...
    \lstinputlisting{ressources/insertion_basique.py}
    ...
    \begin{solution}
        \lstinputlisting{solutions/insertion_basique.py}
    \end{solution}
...
\end{align*}
    ...
    \begin{solution}
        \textbf{Python :}
        \lstinputlisting[language=python, lastline=30]{solutions/merge_sort.py}
    \end{solution}

    \begin{solution}
\lstinputlisting[language=python, firstline=31, firstnumber=31]{solutions/merge_sort.py}
    \end{solution}
...
\begin{Exercice} [20 minutes] \textbf{Tri à bulles (Bubble Sort) - Python \optionnel} \\
    ...
    \begin{itemize}
            \item \textbf{Python :}
                \lstinputlisting{ressources/tri_bulle_basique.py} 
        \end{itemize}
        ...
        \begin{solution}
        \textbf{Python :}
        \lstinputlisting{solutions/tri_bulle_basique.py}
