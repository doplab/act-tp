...
\section{Complexité (40 minutes)}
 ...
 \begin{figure}[H]
        \centering
        \includegraphics[width=9cm]{images/complexity.png}
...
\begin{Exercice}[15 minutes] \textbf{Insertion dans une liste triée - Python}\\
    ...
    \lstinputlisting{code/IntInsertion.py}
...
\begin{Exercice} [30 minutes] \textbf{Tri fusion (Merge Sort) - Python} \\
    ...
    \begin{itemize}
        \item \textbf{Python :}
            \lstinputlisting{code/MergeSort.py}
    \end{itemize}
...
\begin{Exercice} [20 minutes] \textbf{Tri à bulles (Bubble Sort) - Python \optionnel} \\
    ...
    \begin{itemize}
            \item \textbf{Python :}
                \lstinputlisting{code/BubbleSort.py} 
        \end{itemize}
