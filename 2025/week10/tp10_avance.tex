...
\begin{solution}
    \lstinputlisting{solutions/fibonacci_memorization.py} 
\end{solution}
...
\begin{Exercice} [20 minutes] \textbf{Tri fusion (Merge Sort) - Java} \\
    ...
    \end{conseil}
     ...
     \begin{solution}
        \textbf{Java :}
        \lstinputlisting[language=java, firstline=1, firstnumber = 1, lastline=52]{solutions/Question5.java}
    \end{solution}
    \begin{solution}
        \lstinputlisting[language=java, firstline=53, firstnumber = 53]{solutions/Question5.java}
    \end{solution}
    \begin{solution}
