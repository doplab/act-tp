...
\begin{itemize}
    ...
    \begin{solution}
    \textbf{Java:}
    \lstinputlisting{solutions/advanced/BubbleSort.java} 
...
\begin{Exercice} [20 minutes] \textbf{Tri par insertion (Insertion Sort)} \\
    ...
    \begin{itemize}
        ...
        \item \textbf{Java :}
            \lstinputlisting{code/advanced/InsertionSort.java} 
    \end{itemize}
...
\begin{Exercice} [20 minutes] \textbf{Tri fusion (Merge Sort) - Java} \\
    ...
    \end{conseil}
     ...
     \begin{solution}
        \textbf{Java :}
        \lstinputlisting[language=java, firstline=1, firstnumber = 1, lastline=52]{solutions/advanced/MergeSort.java}
    \end{solution}
    \begin{solution}
        \lstinputlisting[language=java, firstline=53, firstnumber = 53]{solutions/advanced/MergeSort.java}
    \end{solution}
    \begin{solution}
