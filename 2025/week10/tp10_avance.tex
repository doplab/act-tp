...
\begin{solution}
    \lstinputlisting{solutions/Fibonacci_memo.py} 
...
\begin{itemize}
        \item \textbf{Java :}
            \lstinputlisting{ressources/BubbleSort.java} 
    \end{itemize}
    ...
    \begin{solution}
    \textbf{Java:}
    \lstinputlisting{solutions/BubbleSort.java} 
...
\begin{Exercice} [20 minutes] \textbf{Tri par insertion (Insertion Sort)} \\
    ...
    \begin{itemize}
        \item \textbf{Python :}
            \lstinputlisting{ressources/InsertionSort.py} 
        \item \textbf{Java :}
            \lstinputlisting{ressources/InsertionSort.java} 
    \end{itemize}
    ...
    \begin{figure}[h!]
        \centering
        \includegraphics[width=10cm]{ressources/InsertionSort.png}
    \end{figure}

    \begin{solution}
        \textbf{Python :}
            \lstinputlisting{solutions/InsertionSort.py} 
        \textbf{Java :}
            \lstinputlisting{solutions/InsertionSort.java}
    \end{solution}
...
\begin{Exercice} [20 minutes] \textbf{Tri fusion (Merge Sort) - Java} \\
    ...
    \begin{itemize}
        \item \textbf{Java :}
            \lstinputlisting{ressources/MergeSort.java}
    \end{itemize}
    ...
    \end{conseil}
     ...
     \begin{solution}
        \textbf{Java :}
        \lstinputlisting[language=java, firstline=1, firstnumber = 1, lastline=52]{solutions/MergeSort.java}
    \end{solution}
    \begin{solution}
        \lstinputlisting[language=java, firstline=53, firstnumber = 53]{solutions/MergeSort.java}
    \end{solution}
    \begin{solution}
