...
\item Tant que la \textbf{file} n'est pas vide, répétez\!:
\begin{enumerate}
    \item Retirez le premier sommet de la file et appelez-le $u$.
    \item Pour chaque sommet adjacent $v$ de $u$\!:
    \begin{itemize}
        \item si $v$ n'est pas encore dans \textbf{visited}, alors :
        \begin{itemize}
            \item ajoutez $v$ à \textbf{visited}.
...
\section{Arbre couvrant minimum (ACM) — Minimum Spanning tree (MST)}
    ...
    \begin{enumerate}
        ...
        \item Pour chaque paire de sommets dans G, S contient le chemin minimax entre ces deux sommets. Le chemin minimax est un chemin pour lequel le poids de l'arête la plus lourde est minimisé.
    \end{enumerate}
...
% --- Draw Vertices (Nodes) ---
    \node[vertex] (A) at (0, 0)     {};
    \node[vertex] (B) at (0, 2)     {};
    \node[vertex] (C) at (1.73, 1)  {};
    \node[vertex] (D) at (3.46, 0)  {};
    \node[vertex] (E) at (3.46, 2)  {};
    \node[vertex] (F) at (5.196, 1)  {};
...
\end{center}
    ...
    \begin{scope}[shift={(0, 2)}]
        ...
        \node[vertex] (C1) at (1.73, 1)  {};
        \node[vertex] (D1) at (3.46, 0)  {};
        \node[vertex] (E1) at (3.46, 2)  {};
        \node[vertex] (F1) at (5.196, 1) {};
    ...
    \begin{scope}[shift={(6.5, 2)}]
        ...
        \node[vertex] (B2) at (0, 2)     {};
        \node[vertex] (C2) at (1.73, 1)  {};
        \node[vertex] (D2) at (3.46, 0)  {};
        \node[vertex] (E2) at (3.46, 2)  {};
        \node[vertex] (F2) at (5.196, 1) {};
    ...
    \begin{scope}[shift={(0, -2)}]
        ...
        \node[vertex] (A3) at (0, 0)     {};
        \node[vertex] (B3) at (0, 2)     {};
        \node[vertex] (C3) at (1.73, 1)  {};
        \node[vertex] (D3) at (3.46, 0)  {};
        \node[vertex] (E3) at (3.46, 2)  {};
        \node[vertex] (F3) at (5.196, 1) {};
    ...
    \begin{scope}[shift={(6.5, -2)}]
        ...
        \node[vertex] (B4) at (0, 2)     {};
        \node[vertex] (C4) at (1.73, 1)  {};
        \node[vertex] (D4) at (3.46, 0)  {};
        \node[vertex] (E4) at (3.46, 2)  {};
        \node[vertex] (F4) at (5.196, 1) {};
...
\begin{solution}
    ...
    \end{solution}
\end{Exercice}
\begin{Exercice}[30 minutes] \textbf{Algorithme de Kruskal\!: Python}\\
