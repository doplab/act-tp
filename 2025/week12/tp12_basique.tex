...
Soit le graphe $G$ donné ci-dessous, déterminer le nombre d'ensembles disjoints (disjoint sets) après les premiers deux appels de \textsc{UNION} dans l'algorithme de Kruskal.
\begin{center}
