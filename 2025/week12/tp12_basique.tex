...
\begin{itemize}
    ...
    \item une liste, appelée \texttt{visited}, de sommets visités initialement le sommet de départ.
...
\begin{enumerate}
    ...
    \item Pour chaque sommet adjacent $v$ de $u$\!: si $v$ n'est ni dans \texttt{visited}, alors :
        \begin{itemize}
