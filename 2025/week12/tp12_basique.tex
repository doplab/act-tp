...
\end{center}
    ...
    \end{conseil}
    \begin{solution}
        \lstinputlisting[language=python, firstline=1, firstnumber=1, lastline=11]{solutions/adj_list_matrix.py}
    \end{solution}

    \begin{solution}
    \lstinputlisting[language=python, firstline=12, firstnumber=12]{solutions/adj_list_matrix.py}
