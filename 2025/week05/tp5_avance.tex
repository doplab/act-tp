...
%     \\
%     En Python, pour créer un tuple, il suffit de définir une variable et de lui assigner, encadré par des parenthèses, un groupe de valeurs séparées entre elles par des virgules:
...
%         \begin{solution}
%             \lstinputlisting{code/advanced/question1.py} 
%         \end{solution}
%     \end{Exercice}
...
elon_musk = {
    ...
    \begin{Exercice}[10 minutes] \textbf{Manipulation d'un dictionnaire}\\
       Gardez le dictionnaire de la question 5 des exercices basiques. Supposons que la traduction du mot ``oiseau'' est mal orthographiée à \texttt{bir}, modifiez la valeur associée à ``oiseau" pour qu'elle devienne ``bird''. Ajoutez un nouvel élément au dictionnaire en associant le mot ``horse'' au mot ``cheval''. \\
...
for x in fr_eng :
    print(x + " : " + fr_eng[x])   \end{lstlisting}
        ...
        \begin{solution}
            \lstinputlisting{solutions/advanced/question3.py} 
        \end{solution}
    \end{Exercice}
...
LinkedList ma_liste = new LinkedList(liste); \end{lstlisting}
    ...
    \begin{Exercice}[5 minutes] \textbf{Lecture de code}\\
      	...
      	\lstinputlisting{code/advanced/Question4.java}
        ...
        \begin{solution}
            On prend l'élément à l'indice 3 de \lstinline{ma_liste} (rappel les indices commencent à 0)\\
            On prend l'élément à l'indice 4 de \lstinline{ma_liste}\\
            Ensuite on recupère l'élément à l'indice 4 de \lstinline{ma_liste} qui 1, et on l'utilise comme key pour \lstinline{mon_dictionnaire}, 1 est associé à un. \\
            Pareil pour le print d'après mais avec l'élément à l'indice 0 qui est 3.\\
   ...
   \begin{Exercice}[10 minutes] \textbf{Création d'une liste à partir d'un tuple (Python)}
        ...
        \begin{solution}
            \lstinputlisting{solutions/advanced/question19.py}
        \end{solution}
    \end{Exercice}
...
Début de la suite : [0,1,1,2,3,5,8,13,...]
    ...
    \begin{solution}
        Via Itération : \\
            ...
            \lstinputlisting{solutions/advanced/Question6Iterative.java} 
            
        Via récursivité : \\
        
            \lstinputlisting{solutions/advanced/Question6Recursive.java}
    \end{solution} 
