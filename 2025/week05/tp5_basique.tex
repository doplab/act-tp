...
for(int i=0;i<ma_liste_m.size();i++){
    System.out.println(ma_liste_m.get(i));
        ...
        \begin{solution}
            \lstinputlisting{code/Question7.java}
        \end{solution}
    \end{Exercice}
...
\begin{Exercice}[10 minutes] \textbf{Itérateurs (Java)}
    ...
    \begin{solution}
        \lstinputlisting{code/Question17.java}
    \end{solution}
\end{Exercice}
...
\begin{Exercice}[5 minutes] \textbf{Lecture de code - 1} 
	...
	\lstinputlisting{code/question18-enonce.py} 
...
\begin{Exercice}[10 minutes] \textbf{Fonction factoriel()} 
        ...
        factoriel(1) = 1, factoriel(2) = $1*2$ = 2, factoriel(3) = $1*2*3$ = 6, factoriel(4) = $1*2*3*4$ = 24,...
            ...
            \begin{solution} 
                ...
                \textbf{Java:}
                \lstinputlisting{code/Question20.java}
            \end{solution} 
...
\begin{Exercice}[10 minutes] \textbf{Fonction getBinaryRepresentation() — Java} 
 ...
 \begin{equation}
    ...
    \end{cases}
\end{equation}
Dans cette formule, $f(a)$ renvoie la représentation binaire sous forme d'une chaîne de caractères du nombre entier $a>0$ et le symbole $+$ fait une concaténation de chaînes de caractères.\newline  \newline 
        Ecrivez la fonction \lstinline{getBinaryRepresentation(String a)} équivalente à $f$ (à part le fait que l'entrée soit une chaîne de caractères) suivant une approche récursive. \\ 
            ...
            \begin{solution} 
                \lstinputlisting[language=Java]{code/Question21.java}
            \end{solution} 
\end{Exercice}
