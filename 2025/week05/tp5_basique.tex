...
ma_liste = [1,2,3,4,5]   \end{lstlisting}
    \end{Example}
     ...
     \begin{Exercice}[5 minutes] [Python] \textbf{Manipulation d'une liste - 1}\\
    ...
    \begin{Exercice}[5 minutes] [Python] \textbf{Manipulation d'une liste - 2}\\
       Qu'affiche le code suivant ? \\
...
elon_musk = {
	...
	\begin{Exercice}[5 minutes] [Python] \textbf{Manipulation d'un dictionnaire - 1}\\
...
\end{lstlisting}
    ...
    \begin{Exercice}[5 minutes] [Python] \textbf{Manipulation d'un dictionnaire - 2}\\
    ...
    \begin{Exercice}[5 minutes] [Python] \textbf{Manipulation d'un dictionnaire - 3}\\
        ...
        \begin{solution}
            \lstinputlisting[language=python, firstline=1, firstnumber = 1, lastline = 8]{solutions/question7.py}
        \end{solution}
        \begin{solution}
            \lstinputlisting[language=python, firstline = 9, firstnumber = 9]{solutions/question7.py}
        \end{solution}
    \end{Exercice}
...
while(i<5){
	...
	\begin{Exercice}[5 minutes] [Python] \textbf{Boucle for et fonction range() - 1}\\
      	Qu'affiche le code suivant ?
...
\end{tabular}
    ...
    \begin{Exercice}[5 minutes] [Python] \textbf{Boucle for et fonction range() - 2}
...
\begin{Exercice}[5 minutes] [Python] \textbf{Listes en compréhension}
    ...
    \begin{solution}
        \lstinputlisting{solutions/question17.py}
    \end{solution}
\end{Exercice}
...
\begin{Exercice}[10 minutes] [Java] \textbf{Itérateurs}
    ...
    \begin{solution}
        \lstinputlisting{solutions/Question18.java}
    \end{solution}
\end{Exercice}
...
\begin{Exercice}[5 minutes] [Python] \textbf{Lecture de code - 1} 
	
	Qu'affiche le programme suivant? \\ 
	
	\lstinputlisting{code/question19.py} 
...
\begin{Exercice}[5 minutes] [Python] \textbf{Lecture de code - 2}
    
	Qu'affiche le programme suivant?
	\lstinputlisting{code/question20.py}
...
\begin{Exercice}[10 minutes] [Python et Java] \textbf{Fonction factoriel()} 
        ...
        factoriel(1) = 1, factoriel(2) = $1*2$ = 2, factoriel(3) = $1*2*3$ = 6, factoriel(4) = $1*2*3*4$ = 24,...
            ...
            \begin{solution} 
                \textbf{Python:}
                \lstinputlisting{solutions/question21.py}
                \textbf{Java:}
                \lstinputlisting{solutions/Question21.java}
            \end{solution} 
...
Dans cette formule, $f(a)$ renvoie la représentation binaire sous forme d'une chaîne de caractères du nombre entier $\mathbf{a\geq 1}$ et le symbole $+$ fait une concaténation de chaînes de caractères.\newline  \newline 
        Ecrivez la méthode \lstinline{getBinaryRepresentation(String a)} équivalente à $f$ (à part le fait que l'entrée soit une chaîne de caractères) suivant une approche récursive. \\ 
            ...
            \begin{solution} 
                \lstinputlisting[language=Java]{solutions/Question22.java}
            \end{solution} 
\end{Exercice}
