...
\begin{document}
    ...
    Le but de cette séance est de mettre en pratique les connaissances du cours sur les structures de données (tuples, listes, dictionnaires), l'itération et la récursivité. Au term de cette séance, l'étudiant saura distinguer structures immuables et non immuables, et écrire des programmes utilisant itération et récursivité. \newline \newline  
...
mon_tuple = (1,"une chaîne de caractères",3,4)   \end{lstlisting}
    ...
    \begin{Exercice}[5 minutes] \textbf{Manipulation d'un tuple}\\
        ...
        \begin{conseil}
            Pour accéder à un élément d'un tuple, ou d'une liste, vous pouvez utiliser l'indexation. Comme pour accéder aux caractères des chaînes de caractères, utilisez \lstinline{[]}. Les indices commencent à zéro.
        \end{conseil}
    ...
    \begin{Exercice}[5 minutes] \textbf{Manipulation d'un tuple}\\
        ...
        \begin{conseil}
        Vous pouvez contrôler si un élément (ou une sous-chaîne de caractères) est contenu dans un tuple, ou une liste, ou une chaîne de caractères en utilisant l'opérateur \lstinline{in}. Si l'élément est dans la liste, la valeur booléenne \lstinline{True} sera retournée. S'il n'y est pas, la valeur booléenne \lstinline{False} sera retournée. 
        \end{conseil}
        
        \lstinputlisting{resources/Questions/question2.py}
...
ma_liste = [1,2,3,4,5]   \end{lstlisting}
    ...
    \begin{Exercice}[5 minutes] \textbf{Manipulation d'une liste - 2}\\
       ...
       \lstinputlisting{resources/questions/question4.py} 
...
elon_musk = {
	...
	\begin{Exercice}[5 minutes] \textbf{Manipulation d'un dictionnaire - 1}\\
       ...
       \lstinputlisting[numbers=none]{resources/animals.txt}
    ...
    \begin{Exercice}[5 minutes] \textbf{Manipulation d'un dictionnaire - 2}\\
      	...
      	\lstinputlisting{resources/questions/question6.py} 
...
for(int i=0;i<ma_liste_m.size();i++){
    ...
    \begin{Exercice}[15 minutes] \textbf{Manipulation de dictionnaires en Java}\\
...
\begin{Exercice}[5 minutes] \textbf{Lecture de code - 1} 
	...
	\lstinputlisting{resources/questions/question18.py} 
...
\begin{Exercice}[5 minutes] \textbf{Lecture de code - 2}
	...
	Qu'affiche le programme suivant?
	\lstinputlisting{resources/questions/question19.py}
...
\begin{Exercice}[10 minutes] \textbf{Fonction getBinaryRepresentation() — Java} 
	
 La représentation binaire d'un entier plus grand que 0 peut être résolue de manière récursive: 
 \begin{equation}
    f(a) = \begin{cases}
    ...
    \end{cases}
\end{equation}
Dans cette formula, $f(a)$ renvoie la représentation binaire sous forme d'une chaîne de caractères du nombre entier $a>0$ et $+$ fait une concaténation de chaînes de caractères.\newline  \newline 
        Ecrivez la fonction \lstinline{getBinaryRepresentation(String a)} équivalente à $f$ (à part le fait que l'entrée soit une chaîne de caractères) suivante une approche récursive. \\ 
            ...
            \begin{solution} 
                \lstinputlisting[language=Java]{resources/solutions/Question21.java}
            \end{solution} 
