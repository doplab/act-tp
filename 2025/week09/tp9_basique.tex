...
\begin{Exercice}[15 minutes]{Création d'une classe abstraite}
	...
	\lstinputlisting{ressources/Question4-6/Animal.java} 
	...
	\begin{itemize}
		...
		\lstinputlisting{ressources/variables_q4.java} 
		\begin{conseil}
...
\end{itemize}
	...
	\begin{solution}
		\lstinputlisting[language=java,lastline=43]{solutions/Figure.java} 
	\end{solution}
	\begin{solution}
		\lstinputlisting[language=java,firstline=44, firstnumber=44]{solutions/Figure.java} 
	\end{solution}
	\end{Exercice}
...
\lstinputlisting{ressources/Question4-6/IMakeSound.java} 
...
\lstinputlisting{ressources/Question4-6/Cat.java} 
\begin{itemize}
...
\begin{solution}
\lstinputlisting{solutions/Question6/Drinkable.java} 
\lstinputlisting{solutions/Question6/Edible.java} 
\lstinputlisting{solutions/Question6/Food.java} 
\end{solution}
