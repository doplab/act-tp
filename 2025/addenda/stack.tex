...
\vspace{1cm}
\begin{itemize}
    \item \begin{tikzpicture}[scale=0.1]
        \draw[->] (2,0) -- (3,0)
            to[out=0,in=90] (4,-1)
            to[out=-90,in=0] (3,-2)
            -- (0,-2);
...
public class LeapYear {
  ...
  \begin{scope}[yshift=-4.5cm] % radius 1cm + 0.5cm gap
    % Draw the stack rectangles
  \draw[thick] (0,0.0) rectangle (4.0,-1.0);
  \draw[thick] (0,-1.0) rectangle (4.0,-2.0);
  \draw[thick] (0,-2.0) rectangle (4.0,-3.0);
...
public class LeapYear {
  ...
  % Second picture shifted down by 0.5 cm
  \begin{scope}[yshift=-6cm] % radius 1cm + 0.5cm gap
    % Draw the stack rectangles
  \draw[thick] (0,0.0) rectangle (4.0,-1.0);
  \draw[thick] (0,-1.0) rectangle (4.0,-2.0);
  \draw[thick] (0,-2.0) rectangle (4.0,-3.0);
...
% slide 5
\begin{frame}[fragile]{\texttt{isLeap:L3} — Calcul d'une valeur booléenne}
\begin{columns}[T]
    % Left column: Code with spotlight
    \column{0.63\textwidth}
    \begin{tikzpicture}
    ...
    \end{lstlisting}
        ...
        \begin{scope}[on background layer]
            ...
            \path let \p1=(code.north west), \p2=(code.north east) in
                ...
                coordinate (winSE) at (\x2, \y1-2.2em); % bottom-right of the window
...
\begin{frame}[fragile]{\texttt{isLeap:L3} — Sortie de la méthode \texttt{isLeap}}
\begin{columns}[T]
    % Left column: Code with spotlight
    \column{0.63\textwidth}
    \begin{tikzpicture}
