...
\begin{Exercice}[30 minutes]\textbf{Insertion dans un Treap: Python et Papier}\\
    ...
    \begin{figure}[h]
        ...
        \includegraphics[width=.3\textwidth]{images/binary_tree.png}
        }
        \subfigure[Arbre non équilibré]{
        \includegraphics[width=.3\textwidth]{images/linked_tree.png}
        }
    ...
    \begin{figure}[h]
        \centering
        \includegraphics[width=.38\textwidth]{images/heap.png}
    ...
    \begin{conseil}
        \begin{itemize}
            ...
            \begin{center}
                \includegraphics[width=\linewidth]{images/treap_heap_property.png}
            \end{center}
    ...
    \begin{center}
        \includegraphics[width=\linewidth]{images/treap.png}
    \end{center}    
    \end{solution}
\end{Exercice}
