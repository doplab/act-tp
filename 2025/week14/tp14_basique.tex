...
\begin{Exercice}[10 minutes]\textbf{Un jeu de hasard : Python}\\
    ...
    \end{conseil}
    \begin{solution}
        \lstinputlisting[language = python, firstnumber = 1, firstline = 1, lastline = 12]{solutions/piece.py}
    \end{solution}
    \begin{solution}
\lstinputlisting[language = python, firstnumber = 13, firstline = 13]{solutions/piece.py}
    \end{solution}
    \end{Exercice}
...
\begin{Exercice}[30 minutes]\textbf{Insertion dans un Treap: Python et Papier}\\
    ...
    \begin{attention}
    Notez ci-dessous les valeurs aléatoires ($r_0$, .., $r_6$) que vous obtiendrez:\\ 
