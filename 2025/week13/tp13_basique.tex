...
\includegraphics[]{images/Quad-Tree 1.PNG}
}
&
\adjustbox{margin=0.3cm}{
\includegraphics[]{images/Quad-Tree 2.PNG}
}
\\
\hline
\end{tabular}
...
\begin{solution}
Image 1 :\\
    \includegraphics[scale=0.65]{images/Quad-Tree 1 solution.PNG}\\
    
Image 2: \\
    \includegraphics[scale=0.65]{images/Quad-Tree 2 solution.PNG}
\end{solution}
\end{Exercice}
...
\includegraphics[]{images/Quad-Tree 3.PNG}
\begin{conseil}
...
\begin{solution}
    ...
    \includegraphics[]{images/Quad-Tree 3 solution 1.PNG}\\
    
    Le Quad-Tree qui en résulte :\\
    
    \includegraphics[scale=0.65]{images/Quad-Tree 3 solution 2.1.png}\\
