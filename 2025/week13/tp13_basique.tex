...
\begin{solution}
   \lstinputlisting[language = python, firstline=1, firstnumber=1, lastline=6]{solutions/K_nearest_neighbor.py}
...
\end{conseil}
\begin{solution}
    \lstinputlisting[language = python, firstline=8, firstnumber=1, lastline=24]{solutions/K_nearest_neighbor.py}
\end{solution}
\end{Exercice}
...
\begin{conseil}
Appliquez l'algorithme du plus proche voisin \textit{K}-fois. À la fin de chaque itération, retirez le voisin le plus proche de l'ensemble des points sur lequel l'algorithme s'applique. De cette façon, vous trouverez le second voisin le plus proche, le troisième, et ainsi de suite. \\
\end{conseil}
...
\begin{attention}
On ne construit pas l'arbre en appelant \texttt{AddKDTree} de manière itérative. On suit l'agorithme présenté dans la Question 4 qui est \texttt{BuildKDTree}.    
\end{attention}
\begin{solution}
Voici le KD-Tree: 
...
Nous aurions pu permuter A et F dans l'arbre et mettre une ligne horizontale à travers A au lieu de F. 
\end{solution}
% \begin{tabular}{|c|}
% \hline
...
\includegraphics[]{img/Quad-Tree 1.PNG}
}
&
\adjustbox{margin=0.3cm}{
\includegraphics[]{img/Quad-Tree 2.PNG}
}
\\
\hline
\end{tabular}
...
\begin{solution}
Image 1 :\\
    \includegraphics[scale=0.65]{img/Quad-Tree 1 solution.PNG}\\
    
Image 2: \\
    \includegraphics[scale=0.65]{img/Quad-Tree 2 solution.PNG}
\end{solution}
\end{Exercice}
...
\includegraphics[]{img/Quad-Tree 3.PNG}
\begin{conseil}
...
\begin{solution}
    ...
    \includegraphics[]{img/Quad-Tree 3 solution 1.PNG}\\
    
    Le Quad-Tree qui en résulte :\\
    
    \includegraphics[scale=0.65]{img/Quad-Tree 3 solution 2.1.png}\\
