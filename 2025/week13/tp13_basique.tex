...
% \end{solution}
\begin{solution}
 \lstinputlisting[language = python, firstline=26, firstnumber=26]{solutions/Question3.py}
\end{solution}
\end{Exercice}
...
\begin{solution}
\lstinputlisting[language = python, firstline=1, firstnumber=1, lastline=17]{solutions/Question6.py}
\end{solution}
\begin{solution}
\lstinputlisting[language = python, firstline=19, firstnumber=19]{solutions/Question6.py}
\end{solution}
\begin{solution}
