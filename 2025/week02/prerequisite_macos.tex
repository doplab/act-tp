...
\begin{enumerate}
    ...
    \begin{conseil}
        Pour déterminer si votre MacOS utilise un processeur Intel ou M: Sur votre Mac, choisissez le menu Pomme \faApple $\rightarrow$ Réglages Système \faGear (la deuxième option dans le menu), cliquez sur Général  dans la barre latérale. Alternativement, \keys{\cmd + \Space} puis composez \texttt{About}.  
    \end{conseil}
