...
Cette séance sera composée de deux parties. Une première partie qui sera consacrée à l'installation des outils de travail et une deuxième partie qui contient des questions à choix multiples en lien avec les notions abordées dans le cours.\\
...
\begin{section}{Installation des outils}
    ...
    \end{comment}
    Suivre le guide suivant pour installer les outils qui seront utilisés lors des prochaines séances de TP. Le guide d'installation des outils sur Windows se trouve \href{https://moodle.unil.ch/pluginfile.php/3691183/mod_resource/content/8/prerequisite_win.pdf}{à cette adresse Moodle} et sur MacOS \href{https://moodle.unil.ch/pluginfile.php/3532600/mod_resource/content/8/prerequisite_macos.pdf}{à cette adresse Moodle}.
\end{section}
...
\\
    ...
    \end{Exercice}
    \begin{solution}
                C'est le rôle du compilateur ou interpréteur d'interpréter les instructions et de les convertir en binaire. Il gère les ressources de l'ordinateur et permet aux différents composants de communiquer entre eux.
    \end{solution}
    % TODO: Explication
...
\begin{Exercice}[3 minutes]
        ...
        \end{solution}
        \begin{conseil}
            Pour avoir une description détaillée d'une commande, vous pouvez ajouter \lstinline{man} devant chaque commande sous Linux/MacOS ou écrire \texttt{help} avant chaque commande sous Windows.
        \end{conseil}
    \end{Exercice}
    ...
    \begin{solution}
        L'écriture et la lecture des fichiers sur les disques. \\
	
	En effet, cet élément est géré par d'autres parties de l'OS, le filesystem ne gère que l'organisation \textbf{virtuelle} des fichiers et dossiers. L'écriture ou lecture physique est faite par le controlleur du disque et le disque dur. \\ 
    \end{solution}
...
\begin{tabular}{| C{0.45\textwidth} | C{0.45\textwidth} |} 
    ...
    \\\\
    \begin{attention}
    Sur MacOS, pour exécuter de code Python depuis le terminal (shell), on écrit \texttt{python3} alors que sur Windows, on écrit \texttt{python}. Vous pouvez aussi essayer d'écrire les deux et voir laquelle fonctionne. Pour exécuter de code Java, on exécute (dans le terminal) d'abord la compilation en écrivant \texttt{javac Example.java} et ensuite \texttt{java Example [arguments séparés par espaces]}.
\end{attention}
...
Alternativement, il est possible de créer un fichier vide directement depuis le terminal au moyen de la command \lstinline{touch hello.py}.
            \item Sous Windows, vous pouvez utiliser la commande \texttt{bash -c \textquotesingle nano hello.py\textquotesingle} dans Powershell. 
        \end{itemize}
    \end{conseil}
    \begin{solution}
    ...
    \begin{Exercice}[10 minutes]
        ...
        \begin{conseil}
            \begin{itemize}
                ...
                \item Pour naviguer dans votre système de fichiers, pensez à utiliser les commandes présentées à la diapositive 20 du cours.
            \end{itemize}
        \end{conseil}
        \begin{solution}
            ...
            Cette erreur se produit lorsque le chemin d'accès à java n'est pas défini dans votre système. Pour corriger cela, lisez la dernière section \textbf{Résolution Bug Windows} dans le document disponible à \href{https://moodle.unil.ch/pluginfile.php/3691183/mod_resource/content/8/prerequisite_win.pdf}{cette adresse Moodle}.
