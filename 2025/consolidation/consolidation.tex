...
\begin{Exercice}[15 minutes]\textbf{Jeu de rôle}
    ...
    \begin{solution}
        \lstinputlisting[language=java,lastline=70]{solutions/Personnage.java}
    \end{solution}
    \begin{solution}
        \lstinputlisting[language=java,firstline=71, firstnumber=71]{solutions/Personnage.java}
    \end{solution}
    
    \begin{solution}
        \lstinputlisting[language=java,lastline=67]{solutions/Guerrier.java}
    \end{solution}
    \begin{solution}
        \lstinputlisting[language=java,firstline=68, firstnumber=68]{solutions/Guerrier.java}
    \end{solution}
    \end{Exercice}
