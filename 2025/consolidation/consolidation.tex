...
\begin{Exercice}[15 minutes]\textbf{Jeu de rôle}
    ...
    \begin{solution}
        \lstinputlisting[language=java,lastline=58]{solutions/Personnage.java}
    \end{solution}
    \begin{solution}
        \lstinputlisting[language=java,firstline=59, firstnumber=59]{solutions/Personnage.java}
    \end{solution}
