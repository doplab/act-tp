...
def nb_voyelles_recursive(T,S) :
    if len(T) == 1 :
        ...
        if T[0] in S :
            return 1 + nb_voyelles_recursive(T[1:],S)
        else :
            return 0 + nb_voyelles_recursive(T[1:],S)
...
print(nb_voyelles_iterative(texte,voyelles))
print(nb_voyelles_recursive(texte,voyelles))