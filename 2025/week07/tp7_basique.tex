...
% \section{Notions d'héritage - Java \optionnel}
...
% \lstinputlisting{ressources/livre-main.java}


% Vous devriez obtenir :

% \lstinputlisting{ressources/livre-main-prompt.java}
...
\lstinputlisting{ressources/FighterMain.java} 

Vous devriez obtenir:
\lstinputlisting{Solutions/fighter-main-solution.txt} 
