...
\lstset{
  ...
  keywordstyle=\color{slideblue},
	morekeywords={with, as, True, False, Fraction, Float, join, None, main, argparse, self, sort, __eq__, __add__, __mul__ ,__ne__, __radd__, __del__, __ge__, __gt__, split, os, endswith, is_file, scandir, @classmethod, this},
	deletekeywords={id},
	showspaces=false,
