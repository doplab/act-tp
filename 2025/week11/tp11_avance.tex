...
\lstinputlisting{resources/plus_proche_binaire.py}
...
\end{conseil}
    ...
    \begin{solution}
        \lstinputlisting[firstline=1, firstnumber=1, lastline=20]{solutions/plus_proche_binaire.py}
    \end{solution}
    \begin{solution}
        \lstinputlisting[firstline=21, firstnumber=21]{solutions/plus_proche_binaire.py}
    \end{solution}
...
\begin{Exercice}[20 minutes] Recherche dans une matrice (Python) %\optionnel\\
    ...
    \lstinputlisting{resources/recherche_matricielle.py}
    ...
    \begin{solution}
        \textbf{Python :}
        \lstinputlisting{solutions/recherche_matricielle.py}
    \end{solution}
