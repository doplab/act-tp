...
% \end{Exercice}
    ...
    \lstinputlisting{resources/question5_2.py}
        ...
        \begin{conseil}
            ...
            \lstinline{s} : L'indice de départ de la partie de la liste à fouiller (0 au départ).\\
            \lstinline{r} : Le dernier indice de la partie de la liste à fouiller (\lstinline{len(L) - 1} au départ).\\
