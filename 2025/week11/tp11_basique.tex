...
\end{conseil}
    ...
    \begin{exemple}
        \lstinputlisting[language=python, firstline=13, firstnumber=1, lastline=17]{solutions/question1-2.py}
    \end{exemple}
    ...
    \begin{solution}
        \textbf{Python:}
        \lstinputlisting[language=python, firstline=6, firstnumber=6]{solutions/question1-2.py}
    \end{solution}
    ...
    \begin{exemple}
        \lstinputlisting[language=python, firstline=16, firstnumber=1, lastline=22]{solutions/question2.py}
    \end{exemple}
