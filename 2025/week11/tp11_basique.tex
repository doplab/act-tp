...
\end{conseil}
    ...
    \begin{solution}
    \textbf{Python:}
    \lstinputlisting[deletekeywords={index}]{solutions/question1.py}
    \end{solution}
    ...
    \begin{exemple}
        \lstinputlisting[language=python, firstline=17, firstnumber=1, lastline=21]{solutions/question1-2.py}
    \end{exemple}

    \begin{solution}
        \textbf{Python:}
        \lstinputlisting[language=python, firstline=1, firstnumber=1, lastline=5]{solutions/question1-2.py}
    \end{solution}

    \begin{solution}
        \textbf{Python:}
        \lstinputlisting[language=python, firstline=8, firstnumber=8]{solutions/question1-2.py}
    \end{solution}
    ...
    \begin{exemple}
        \lstinputlisting[language=python, firstline=18, firstnumber=1, lastline=24]{solutions/question2.py}
    \end{exemple}
