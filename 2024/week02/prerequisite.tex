...
Pour finir, accédez aux variables d’environnement : \\

Tapez variables dans la barre de recherche, prenez "Modifier les variables d'environnement système". Cliquez sur "variables d'environnement" \\
