...
\begin{itemize}
	\item Comprendre le rôle d'une variable et les types de variables existants.
    \item Découvrir les différentes représentations de nombres.
	\item Utiliser des notions d'algèbre booléenne.\\
\end{itemize} 

Les langages qui seront utilisés pour cette séance sont Java et Python. Assurez-vous d'avoir bien installé Intellij. Si vous rencontrez des difficultés, n'hésitez pas à vous référer au guide suivant: \href{https://moodle.unil.ch/mod/resource/view.php?id=1132316}{tutoriel d'installation des outils et prise en main de l'environnement de travail}.\\
...
\begin{Exercice}[5 minutes]  \textbf{Les types de variables}\\
    ...
    \begin{solution}
    	...
    	\lstinputlisting{updated/solutions/Question7.py} 
    	
    	
    	En Java : 
    	
    	\lstinputlisting{updated/solutions/Question7.java} 
...
\begin{Exercice}[10 minutes]  \textbf{Typage statique et dynamique}\\
    ...
    \lstinputlisting{updated/Question8.java} 
    
    \textbf{Python :}
    
    \lstinputlisting{updated/Question8.py} 
...
\begin{Exercice}[10 minutes] \textbf{Conversion des variables (Type casting) (Java ou Python)}\\
    Qu'afficheront les programmes suivants ? \\
    
    \textbf{Python:}
    \lstinputlisting{updated/Question9.py}
    
    \textbf{\\Java:}
    \lstinputlisting{updated/Question9.java}
...
\begin{Exercice}[5 minutes] Qu'affichera le programme suivant?
    ...
    \lstinputlisting{updated/Question10.py}
...
\begin{Exercice}[5 minutes] Qu'affichera le programme suivant?
    ...
    \lstinputlisting{updated/Question11.py}
...
\begin{Exercice}[5 minutes] Qu'affichera le programme suivant?
    ...
    \lstinputlisting{updated/Question12.py}
