...
\textbf{Python} \\
    ...
    \lstinputlisting{resources/iteration_recursion_exercice.py} 

\textbf{Java} \\

    \lstinputlisting{resources/iteration_recursion_exercice.java}
...
\textbf{\\Programme 1 :} \\
    ...
    \lstinputlisting{resources/recursion_1_exercice.py} 

\textbf{Programme 2 :} \\

    \lstinputlisting{resources/recursion_2_exercice.py}
...
\begin{Exercice}[5 minutes] Complexité - Partie 1\\
    ...
    \lstinputlisting{resources/week5_algo1_complexite.py}
\begin{conseil}
...
\begin{Exercice}[5 minutes] Complexité - Partie 2\\
    Que fait le programme suivant? \\
    Estimez le nombre d'opérations qu'effectuera l'algorithme de la fonction \lstinline{algo2} à chaque étape en fonction des paramètres qui lui seront assignés. Déterminez sa complexité.
    \lstinputlisting{resources/week5_algo2_complexite.py}
\begin{conseil}
   Les opérations dans une boucle \lstinline{for} sont répétées autant de fois que le 
   nombre d'éléments sur lesquels nous itérons.
\end{conseil}
...
\begin{Exercice}[5 minutes] Complexité - Partie 3\\
    Que fait le programme suivant? \\
    Estimez le nombre d'opérations qu'effectuera l'algorithme de la fonction \lstinline{algo3} à chaque étape en fonction des paramètres qui lui seront assignés. Déterminez sa complexité.
    \lstinputlisting{resources/week5_algo3_complexite.py}
\begin{conseil}
...
\begin{solution}
    ...
    \begin{enumerate}
        ...
        \item Dans la boucle, l'algorithme effectue 2 opérations, additionner \lstinline{i} à \lstinline{s} et multiplier \lstinline{i} par 2. 
    \end{enumerate}
    ...
    $\{1, 2, 4, 8, 16, ..., n\}$, qui est logarithmique. Nous avons alors au total : $2 \times \log(n) + 2$ opérations. \\
    En notation $O()$, nous avons une complexité de : $O(2 \times \log(n) + 2) = O(\log(n))$ car les constantes sont ignorées. 
...
\begin{Exercice}[15 minutes] \textbf{Tri fusion (Merge Sort)}
    ...
    \begin{itemize}
        ...
        \item Inspirez vous de la solution de l'exercice 8 (exercices basiques) de la série 5. 
        \item N'hésitez pas à revoir le processus montré en cours (visualisation de l'algorithme dans les diapositives 84 à 108) pour comprendre comment marche concrètement le tri fusion. 
    \end{itemize}
    \end{conseil}
    \begin{solution}
        \textbf{Python :}
...
\textbf{Python}
    ...
    \lstinputlisting{resources/binary_search_closest_exercice.py} 

\textbf{Java}
    \lstinputlisting{resources/binary_search_closest_exercice.java}
...
\begin{conseil}
    ...
    Téléchargez le fichier \lstinline{question15.py} se trouvant dans le dossier \lstinline{code} et écrivez votre code à partir de la ligne 66. 
\end{conseil}

\begin{solution}
    \textbf{Python} \\

    \lstinputlisting{solutions/question15.py} 
\end{solution}
