...
\begin{enumerate}
    ...
    Sur windows lors du test, le terminal peut vous renvoyer vers le store d'application windows pour télécharger denouveau python. Si tel est votre cas, téléchargez le.
