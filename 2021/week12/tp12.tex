...
\begin{Exercice}[10 minutes] Getters et setters\\
    ...
    Pour les attributs publics, il vous suffit d'utiliser \lstinline{nom_instance.attribut} pour l'obtenir. \\
...
\begin{Exercice}[5 minutes] Manipulation d'attributs - Listes\\
    Créez une méthode \lstinline{public} nommée \lstinline{add_trick(String trick)} qui prend en entrée une chaîne de caractères et l'ajoute à la liste \lstinline{tricks}. \\
...
\begin{Exercice}[5 minutes] Manipulation d'attributs - setter\\
    Créez deux méthodes permettant de modifier l'attribut \lstinline{mood} du \lstinline{Dog}. La méthode \lstinline{leash()} décrémentera \lstinline{mood} de 1 et \lstinline{eat()} l'incrémentera de 3. \\
...
\begin{Exercice}[15 minutes] Classe Point
    \begin{itemize}
        ...
        \end{conseil}
        \item Définissez une méthode \lstinline{distance} qui prend en entrée l'instance du Point (\lstinline{self}) et un autre point \lstinline{p2}. Cette méthode \lstinline{distance} retournera la distance euclidienne entre le point \lstinline{self} et \lstinline{p2}. 
        \begin{conseil}
