...
\begin{note}{"Nathan"}
    ...
    q12: basique
\end{note}
Les codes présentés dans les énoncés se trouvent sur Moodle, dans le dossier \lstinline{Ressources}.
...
On peut créer une classe en Java en utilisant le mot-clé class. Par exemple ;
