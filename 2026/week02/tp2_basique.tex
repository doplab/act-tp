...
Alternativement, il est possible de créer un fichier vide directement depuis le terminal au moyen de la commande \lstinline{touch hello.py}.
    ...
    \begin{solution}
        ...
        Dans le cas de cette question, on fera: \lstinline{python hello.py} ou, sur macOS, \lstinline{python3 hello.py}.
...
\end{Exercice}    
\begin{solution}
	On peut citer \lstinline{Numpy}, \lstinline{Scikit}, \lstinline{PyTorch} qui sont utilisées pour faire du Machine Learning. \\
    ...
    \begin{tabular}{lll}
        \textbf{Bibliothèque} & \textbf{Utilisation} & \textbf{Lien} \\ \hline
        NumPy & Calcul scientifique & \url{https://numpy.org/} \\
        Scikit-learn & Machine Learning & \url{https://scikit-learn.org/} \\
        PyTorch & Machine Learning & \url{https://pytorch.org/} \\
        Matplotlib & Création de graphiques & \url{https://matplotlib.org/} \\
        Pandas & Analyse de données & \url{https://pandas.pydata.org/} \\
        SQLAlchemy & Gestion de bases de données & \url{https://www.sqlalchemy.org/} \\
    \end{tabular}
