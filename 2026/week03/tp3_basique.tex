...
\begin{Exercice}[10 minutes]  \textbf{Typage statique et dynamique}\\
    ...
    \begin{solution}
        ...
        \begin{itemize}
        	\item Programme 1: OK
        	\item Programme 2 : Ce code ne fonctionnera pas car on essaie de changer le type de la variable\_2, ce qui est impossible avec un typage statique comme en java. Ici le type de la variable est déduit lors de la compilation du programme.
        	...
        	\item Programme 4: Ce code ne fonctionnera pas car on essaie de changer le type de la variable\_1, ce qui est impossible avec un typage statique comme en java. Ici le type de la variable est déduit lors de la compilation du programme.
        	\item Programme 5: OK
        	\item Programme 6: Ce code ne fonctionnera pas car on essaie de changer le type de la variable\_1, ce qui est impossible avec un typage statique comme en java. \\
        \end{itemize}
