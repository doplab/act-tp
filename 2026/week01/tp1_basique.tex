...
\begin{Exercice}[15 minutes]  \textbf{Conversion $Base_{10}$ - $Base_3$, $Base_8$, $Base_{16}$}\\
    ...
    \end{conseil}
    \begin{solution}
        Dans cette solution, la méthode 2 sera utilisée pour 52 en base 3, et la méthode 1  pour 254 en base 16. \\
    ...
    \end{solution}
    \begin{solution}
        \textbf{Méthode 1 pour 254 (ici, nous sommes en base 10)} \\
        ...
        \medskip
        \textbf{Méthode 2 pour 40 (en base 8 donc on divise par 8)}
        \medskip
        \begin{tabular}{| C{0.1\textwidth} | C{0.1\textwidth} |} 
        \hline
        \textbf{nombre} & \textbf{reste}\\ [0.5ex]
