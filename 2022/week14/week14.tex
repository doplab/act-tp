...
En assimilant le nombre de chiffres(faces) distincts obtenus aux états d'une chaîne de Markov, représentez sa matrice de transition associée.
    ...
    \begin{itemize}
        \item Etat 0: avant le lancement du des, 0 face obtenus.
        \item Etat 1: une face obtenue avec propabilité 1 si l'état précedent est l'état initial, comme on tombera toujours sur une nouvelle face au premier lancer. 
        Sinon on reste au même état avec une probabilité 1/6 (on tombe sur le même chiffre).
        \item Etat 2: deux faces distincts obtenues, on peut arriver à cet état soit à partir de l'état 1 en tombant sur une nouvelle 
        ...
        \item ...
        \item Etat 6 : toutes les faces sont obtenues on peut que retomber sur le même état, donc propabilité égale à 1. 
    \end{itemize}
