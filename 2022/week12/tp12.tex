...
\begin{Exercice}[20 minutes]  \textbf{Breadth-First Search algorithm : Python}\\
    ...
    \begin{conseil}
        ...
        \begin{enumerate}
            ...
            \item Vous pouvez utiliser la méthode .pop() pour supprimer un élément d'une liste et retourner l'élément supprimé. Cet élément peut être stocké dans une variable.
        \end{enumerate}
    \end{conseil}
    \begin{solution}
