...
def proba(n,l,iter):
    #Codez , n correspond au nombre de succès et l au nombre d'essais. Iter correspond au nombre d'expériences que vous allez réaliser pour obtenir la réponse. Cela devrait être grand mais pas trop (sinon le programme prendra trop de temps.)
