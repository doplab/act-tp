...
\begin{Exercice}[5 minutes] \textbf{Decode}
    ...
    \begin{conseil}
        ...
        Les données issues de la décomposition de l'\lstinline{Instruction Register} ne sont pas des valeurs brutes, mais des références. Trouvez les tables correspondantes pour y récupérer les valeurs.
    \end{conseil}
