...
\begin{Exercice}[15 minutes]  \textbf{Conversion $Base_{10}$ - $Base_3$, $Base_8$, $Base_{16}$}\\
    \begin{note}{"Nathan"}
    Difficulté basique, temps adéquat
    \end{note}
    \begin{enumerate}
...
\begin{Exercice}[15 minutes] \textbf{Addition de nombres binaires}
    \begin{note}{"Nathan"}
    Difficulté basique, temps adéquat, essentiel à comprendre
    \end{note}
    \begin{enumerate}
...
\begin{Exercice}[15 minutes] \textbf{Soustraction de nombres binaires}\\
    \begin{note}{"Nathan"}
    Difficulté basique, temps adéquat, essentiel à comprendre et maitriser 
    \end{note}
...
\end{note}
\begin{note}{"Nathan"}
    Les deux exercices suivants devraient être avancés
    \end{note}
\begin{note}
...
Dans cette section, nous allons simuler une opération d'addition dans le \textbf{modèle de Van Neumann}, il va vous être demandé à chaque étape (FDES) de donner la valeur des registres.\\
    \begin{note}{"Nathan"}
    Difficulté basique, temps adéquat pour tous les exercices ci dessous
    \end{note}
