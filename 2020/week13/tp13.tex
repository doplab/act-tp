\begin{note}{Maeva}
    Même commentaire que pour les exercices de la semaine d'avant, pourquoi mettre python en exercices avancés pour cette semaine ci (ex1 et héritage)
\end{note}
...
%Appeler la méthode via le mot clé \lstinline{super} effectuera et renverra ce que la méthode de la classe mère effectue et renvoie.
