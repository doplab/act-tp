...
\begin{solution}
\textbf{Python :}
    \lstinputlisting{ressources/question5.py}
...
\begin{comment}
    % Remarks: Incohérent. Bulle sort ≠ Insertion sort
...
\begin{itemize}
    ...
    \begin{solution}
    \textbf{Python :}
    \lstinputlisting{ressources/question7.py} 
    \textbf{Java:}
    \lstinputlisting{ressources/question7.java} 
...
\begin{Exercice} [30 minutes] \textbf{Tri fusion (Merge Sort)} \\
    ...
    \begin{solution}
        \textbf{Java :}
        \lstinputlisting{striped_files/question9_1.java}
    \end{solution}
    \begin{solution}
        \lstinputlisting{striped_files/question9_2.java}
