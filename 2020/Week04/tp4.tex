...
\begin{document}
    ...
    \begin{note}{"Etienne"}
        L'exercice n'est pas difficile mais je pense qu'il demanderait 10 minutes au lieu de 5 pour une première manipulation de dictionnaire
    \end{note}            
    ...
    \begin{note}{"Etienne"}
        Je mettrai 15 minutes pour la même raison que precedemment.
...
\end{note} 
    ...
    \begin{note}{"Etienne"}
        Cet exercice devrait être considéré comme optionnel. Celui sur les factoriels me semble de même niveau mais beaucoup plus important.
    \end{note}
