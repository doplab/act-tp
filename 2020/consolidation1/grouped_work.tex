...
\begin{solution}
    ...
    $\{1, 2, 4, 8, 16, ..., n\}$, qui est logarithmique. Nous avons alors au total : $2 + \log(n)$ opérations. \\
    En notation $O()$, nous avons une complexité de : $O(\log(n) + 2) = O(\log(n))$ car les constantes sont ignorées. 
