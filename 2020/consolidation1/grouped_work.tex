...
\begin{Exercice}[5 minutes] Insertion arbre binaire \\
Dans cette exercice nous allons insérer un élément dans un arbre binaire.\\
#TO DO Insérer image de larbre initial et image de l'arbre final\\
