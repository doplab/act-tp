...
\begin{document}
    ...
    \begin{Exercice}[5 minutes] \textbf{Manipulation d'un tuple - 3}\\
        ...
        Choisissez parmis les éléments suivants : \\
    ...
    \begin{Exercice}[5 minutes] \textbf{Manipulation d'un dictionnaire - 3}\\
      	...
      	Choisissez parmis les possibilités suivantes : \\
    ...
    \begin{Exercice}[5 minutes] \textbf{Boucle for en Python)}
        ...
        \begin{conseil}
		   Faites les étapes de la boucle une après l'autre et voyez ce que vous obtenez (avec chauqe valeur).  
        \end{conseil}
