...
\begin{document}
    ...
    \begin{Exercice}[5 minutes] \textbf{Boucle for en Python} \\
        ...
        \begin{conseil}
		   Ici, nous avons affaire à une boucle \lstinline{for} Python, \lstinline{c} prendra donc la valeur de chaque élément de la liste.  
        \end{conseil}
    ...
    \begin{Exercice}[5 minutes] \textbf{Boucle for en Java} \\
        ...
        \begin{conseil}
		   Ici, nous avons affaire à une boucle \lstinline{for} Java, \lstinline{i} prendra donc toutes les valeurs entre 0 et \lstinline{ma_liste.size()}.   
        \end{conseil}
    ...
    \begin{Exercice}[5 minutes] \textbf{Boucle while en Python} \\
        ...
        \begin{conseil}
		   Ici, nous avons affaire à une boucle \lstinline{while} Python, les lignes dans la boucle s'effectueront jusqu'à ce que \lstinline{i} vaille 5.   
        \end{conseil}
    ...
    \begin{Exercice}[5 minutes] \textbf{Boucle while en Java} \\
        ...
        \begin{conseil}
		   Ici, nous avons affaire à une boucle \lstinline{while} Java, les lignes dans la boucle s'effectueront jusqu'à ce que \lstinline{i} vaille 5.  
        \end{conseil}
	...
	\begin{Exercice}[5 minutes] \textbf{Boucle for et fonction range() - 1} \\
        ...
        \begin{conseil}
		   La fonction \lstinline{range(n)} permet de créer une liste contenant tous les entiers de 0 à (n-1) .
        \end{conseil}
