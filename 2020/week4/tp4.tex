...
\end{comment}
    ...
    \begin{Exercice}[10 minutes] \textbf{Boucle while et des étudiants}
        ...
        \begin{solution}
            ...
            \lstinputlisting{resources/question20for.py}
            
            Solution avec la boucle \lstinline{while} :
            
            \lstinputlisting{resources/question20while.py}
...
\begin{Exercice}[5 minutes] \textbf{Lecture de code - 2}
	...
	factoriel(1) = 1, factoriel(2) = $1*2$ = 2, factoriel(3) = $1*2*3$ = 6, factoriel(4) = $1*2*3*4$ = 24,...
        ...
        \begin{solution} 
            ...
            \textbf{Java:}
            \lstinputlisting{resources/question25.java}
		\end{solution} 
	...
	Début de la suite : [0,1,1,2,3,5,8,13,...]
		...
		\begin{solution}
			Via Itération : \\
				...
				\lstinputlisting{resources/question26it.java} 
				
			Via récursivité : \\
			
				\lstinputlisting{resources/question26r.java}
		\end{solution} 
