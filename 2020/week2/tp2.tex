...
\\
    ...
    \end{solution}
        ...
        Pour quelle(s) propositions le système d'exploitation sert d'interface ? Plusieures réponses sont possibles
        \begin{enumerate}
		...
		\item Hardware - Software. Exemple: L'antenne wifi qui permet l'accès à internet notamment avec des navigateurs web.
	    \end{enumerate}
