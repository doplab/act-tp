...
\\
    ...
    \begin{solution}
		...
		Ce n'est donc pas un système d'exploitation, mais un software. C'est  un niveau d'abstraction au dessus du système d'exploitation.
    \end{solution}
    % TODO: Explication
    ...
    \begin{solution}
		...
		Le système d'exploitation va  servir à faire l'interface entre tout ce qu'il se passe sur l'ordinateur et le hardware, notamment le processeur.
    \end{solution}
    % TODO: Explication
