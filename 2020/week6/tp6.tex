...
\begin{note}{"Nathan"}
    ...
    q2: basique
    q3: basique
    q4: basique pour la partie itérative, avancé en terme d'asbtration pour le récursivité ( les étuidants ont souvent du mal à maitriser cette notion )
    q5: avancé
    q6: basique
    q7: avancé
    q8: basique  
