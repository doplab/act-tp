...
\begin{note}{"Etienne"}
    Je mettrai également celui-ci en optionnel car les exercices de la fin sur les algorithmes de tris me semblent plus pertinents à conserver en obligatoires.
\end{note}
\begin{Exercice}[10 minutes] \textbf{Complexité} \\
    Quelle est la complexité du programme ci-dessous?\\
    \textbf{Python :}
...
\section{Algorithmes de Tri (60 minutes)}
 ...
 \begin{note}{"Etienne"}
    Je partage aussi l'idée ne de demander l'implémentation de ces algorithmes que dans un seul language si possible et selon ce qui est ensuite attendu.
\end{note}
