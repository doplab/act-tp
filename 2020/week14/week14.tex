...
\ShowConseiltrue
\titre
\cours{Classes abstraites et interfaces en Java}
...
Cette série d'exercices est divisée en \todo{define section} sections dont une section facultative (avec le label \optionnel). Le seul langage qui sera utilisé sera \lstinline{Java}.
