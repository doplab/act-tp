...
\begin{note}{"Etienne"}
    Remarque générale sur la série: elle comporte beaucoup d'exercices et peut en decourager certains.
    Même si ces exercices sont rapides à faire, le premier de chaque catégorie (premiere question de chaque section) peut demander plus de temps
    à un élève qui prend en main deux languages de programmation pour la première fois.
\end{note}
