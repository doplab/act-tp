...
\begin{note}{"Etienne"}
    Peut-être preciser le mode utiliser (représentation signée, complément à deux, ...) ?
\end{note}
...
\begin{note}{"Etienne"}
    Similaire à exercice 4, peut-être preciser le mode utiliser (représentation signée, complément à deux, ...) ?
\end{note}
...
\begin{note}{"Etienne"}
    Il serqit utile de preciser qu'on ne travaille pas avec un nombre de bits fixes donc qu'il ne peut pqs y avoir de depassement de capacité.
\end{note}
...
\begin{note}{"Etienne"}
    Etant donné qu'il y encore l'exercice sur le modèle de Von Neumann qui suit et qui est important,
    il peut être raisonnable de marquer celui-ci comme facultatif afin de permettre aux étudiant de travailler sur les deux sujets. 
\end{note}
