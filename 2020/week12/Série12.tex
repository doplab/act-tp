...
Le but de cette première partie est de créer votre propre classe en Java. Cette classe sera une classe nommée \lstinline{Dog()} sensée représenter un chien.
...
\begin{Exercice}[10 minutes] Exercice 1\\
    Commencez par créer une nouvelle \lstinline{Java} Class dans votre projet, et initialisez les attributs suivants :
    \begin{enumerate}
