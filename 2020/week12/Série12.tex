...
\begin{itemize}
    ...
    \item \lstinline{attaque:}\text{(int)}
...
\begin{Exercice}[Durée 5 minutes] isAlive()\\
    isAlive() est une méthode qui consiste à retourner \lstinline{true} si l'instance a plus que 0 points de vie et \lstinline{false} si l'instance en a moins.
