...
\includegraphics[]{resources_latex/sortie_juste.PNG}
...
\textbf{Java :}
         \lstinputlisting{ressources_exo_nathan/graph_empty.java}
    \begin{enumerate}
    ...
    \begin{solution}
    \textbf{Java :}
         \lstinputlisting{ressources_exo_nathan/Edges.java}
    \end{solution}
    \begin{solution}
    \textbf{Java :}
         \lstinputlisting{ressources_exo_nathan/graph.java}
    \end{solution}
    \begin{solution}
    \textbf{Java :}
         \lstinputlisting{resources_latex/graph2.java}
    \end{solution}
