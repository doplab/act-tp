...
\begin{solution}
\begin{align}
    P(X_0=0,X_1=1, X_2=2) &= P(X_0 =0)\times p_{01} \times p_{12} = 0.3 \times 0.2 \times 0.0 = 0.0\\
     P(X_0=0,X_1=1, X_2=1)&=P(X_0 =0)\times p_{01} \times p_{11} = 0.3 \times 0.2\times 0.1 = 0.006
\end{align}
\end{solution}
\end{Exercice}
...
\begin{Exercice}[20 minutes]\textbf{Insertion dans une Treap: Python} \optionnel\\
    ...
    combinaison d'un arbre de recherche binaire et d'une heap. Ainsi, la treap a la même strucutre qu'un arbre de recherche binaire dont les noeuds sont
