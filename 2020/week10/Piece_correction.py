...
def proba(n,l,iter=10000):
    #n correspond au nombre de succès et l au nombre d'essais. Iter correspond au nombre d'expérience que vous allez réaliser pour obtenir la réponse. Cela devrait être grand mais pas trop (sinon le programme prendra trop de temps à s'exécuter).
    #10000 est un bon nombre d'itérations.
    proba = 0
    for i in range(iter):
    ...
    return proba/iter#Divise notre estimateur de probabilité par le nombre total d'expériences réalisées.
