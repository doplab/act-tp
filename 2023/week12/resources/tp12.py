...
class Graph:
    ...
    # Les sommets du graphe sont notés par des valeurs (ici, A,B,C,...), cette fonction liste toutes
...
A = graphe.get_node('A')
Arrete_liee_noeud_A = A.relationships  # Cette variable contient une liste d'arête
# À ce stade, vous ne savez pas encore comment "lire" ce que contient la variable Arrete_liee_noeud_A

print("Le nombre d'arête liée à A est : {}.".format(len(Arrete_liee_noeud_A)))
...
vertice = Arrete_liee_noeud_A[1]  # On sélectionne la 2ème arête liée au sommet A (pour rappel les indices d'une liste
# Python commence à 0)
