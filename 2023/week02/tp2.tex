...
\begin{section}{Installation des outils}
    ...
    \end{comment}
    Suivre le guide suivant pour installer les outils qui seront utilisés lors des prochaines séances de TP. Le guide d'installation des outils se trouve à cette adresse: \url{https://moodle.unil.ch/mod/resource/view.php?id=1580677}.
\end{section}
